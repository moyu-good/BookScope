...
## [1.9.0] - 2026-07-28 · 分析台大改：按书自适应、进门先看概览、可视化全翻新

这版把整个分析台重做了一遍。功能按「你想干什么」归成几个镜头，每类书只上它该有的那套，进门先看一张「这本书能做什么」的概览，可视化全部翻新。

### 新功能

- **进门先看概览**。点书库里的书（整张卡片都能点），先落一张「这本书能做什么」的页，按书的类型列出该做的几件事，点一件进去，不再一进来就卡在问答框前发懵。
- **按书自适应**。系统认出这是叙事的书（小说、故事型历史）还是论述的书（理论、分析型历史），只给它该有的那套镜头：叙事的书看人物和情节，论述的书看论点、概念和学者立场，不再一股脑全堆给你。
- **立场格局**（人物）。把书里主要人物一口气打在一张十字图上，横看戏份、纵看立场倾向，谁站哪边一眼看清；点谁，看他正反两面的原文取证，有争议的把两面都摆出来、不替你下定论。
- **学者立场谱**（理论 / 论述书）。书里引到的思想家，按本书核心争论摆在十字图上，谁挺谁反、谁被谈得多；点谁，看书里怎么刻画他。
- **论点结构**改成论证骨架树。中心论点在上，支撑它的论点分层挂在下面，每条钉在原文。
- **概念关系图**。核心概念怎么勾连（定义 / 包含 / 对立 / 因果），越核心的概念颜色越深。
- **人物关系图翻新**。干净的浅底网络图，鼠标停在谁身上只亮他这一圈；敌友按原文判色；图外还列出自动分的阵营名册。
- **镜头整合**。人物（关系图 / 关系演变 / 命运线 / 声口）、情节脉络、质量 · 写作、单份公文各自收成一个镜头，进去分段看，左栏不再堆一长条。
- **存图**。关系图这类可视化能一键导出图片，方便分享。

### 修了什么

- 关系图敌友判定收紧：君臣、上下级这类身份不再被误判成敌对，只在原文真写了冲突时才标。
- 大书打开更快：几百万字的书第一次读会在后台把整本通读一遍、带进度提示，读完之后再点各功能就快了。

### 底层改进

- 分析引擎按内容识别叙事 / 论述，左栏功能门控、论点梳理都据此走；可视化统一了入口卡与钤印视觉语言。

## [1.8.2] - 2026-07-02 · 公文「弦外之音」更准：少读错、不瞎猜

1.8.1 让公文的方针条款会点破「弦外之音」（官腔话里有话，比如「原则上」留了口子、「结合实际」给了自由裁量）。这版拿真公文核了一遍这些判断准不准，发现有几个词经常读错，收紧了。

### 修了什么

- **「弦外之音」不再瞎猜**：`原则上`、`依法依规`、`研究`、`稳步`这几个词，在真公文里多半是中性的程序话（「原则上X、特殊情况Y」是把例外明写出来的正常写法，不是藏猫腻；「依法依规」就是照章办事），以前一律点成「有口子 / 当挡箭牌 / 搁置」是过度解读。这版把这几个词收掉了——只在「结合实际」「另行规定」「逐步」「适时」这类真有弦外之意的词上点，宁可少点几个，也不瞎猜。核下来错读率从六成降到不足一成。
