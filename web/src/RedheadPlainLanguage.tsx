...
//
// 【已退役 · 软退避保留一个版本周期】（1.6 公文整合，设计稿 WP-redhead-consolidation 整合 2）：
// 大白话已成为「逐条精读」（RedheadCloseReading.tsx）的核心数据源——逐条精读每条卡的大白话主体
// 就是这块逐条翻译的能力，再叠上结构标签 + 内联术语。App.tsx 的 redhead_plain 位已 relabel 成
// 「逐条精读」、渲染 RedheadCloseReading，不再渲染本组件。本文件暂留备查，下一个版本周期确认无
// 回退需求后删除。/redhead/plain-language 端点仍在（逐条精读复用其逐条改写逻辑，未直接调端点）。
//
