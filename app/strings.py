...
_STRINGS: dict[str, dict] = {
    "en": {
        ...
        "type_biography": "Biography & Memoir",
        "type_short_stories": "Short Stories",
        "type_poetry": "Poetry",
        "type_academic": "Academic",
        "type_essay": "Essay",
        "type_technical": "Technical",
        "type_self_help": "Self-Help",
        # Quick Preview
        ...
        # Chat suggested prompts (labels only — prompts sent to LLM are in chat.py)
        "chat_suggest_fiction_1": "📖 What happens in each section?",
        "chat_suggest_fiction_2": "👥 Who are the main characters?",
        "chat_suggest_biography_1": "📷 What does this reveal about the subject?",
        "chat_suggest_biography_2": "🌟 Key turning points in their life?",
        "chat_suggest_short_stories_1": "📖 Summarize each story.",
        "chat_suggest_short_stories_2": "💥 Which story hits hardest?",
        "chat_suggest_poetry_1": "🎭 What is the central theme?",
        "chat_suggest_poetry_2": "🖊 Describe the poet's voice.",
        "chat_suggest_academic_1": "📝 What is the core argument?",
        "chat_suggest_academic_2": "🔑 What are the key concepts?",
        "chat_suggest_essay_1": "✍️ What is the author's core theme?",
        "chat_suggest_essay_2": "💭 Analyze the narrative voice.",
        "chat_suggest_technical_1": "⚙️ What problem does this book solve?",
        "chat_suggest_technical_2": "🔑 Key concepts and methods taught?",
        "chat_suggest_self_help_1": "💡 What framework does this book teach?",
        "chat_suggest_self_help_2": "✅ Most actionable insights?",
        # Library Tab
        "tab_library": "📚 Library",
        ...
        # Reader Verdict
        "verdict_label": "READER VERDICT",
        "verdict_for_you": "Great for",
        "verdict_not_for_you": "Skip if",
        "verdict_low_confidence": "Limited data — rough guide only",
    ...
    "zh": {
        ...
        "type_fiction": "小说",
        "type_biography": "传记 · 回忆录",
        "type_short_stories": "短篇小说",
        "type_poetry": "诗歌",
        ...
        "chat_suggest_fiction_1": "📖 每章讲了什么？",
        "chat_suggest_fiction_2": "👥 主要人物是谁？",
        "chat_suggest_biography_1": "📷 这本书揭示了传主的什么特质？",
        "chat_suggest_biography_2": "🌟 传主人生中的关键转折点？",
        "chat_suggest_short_stories_1": "📖 简述每个故事的内容。",
        "chat_suggest_short_stories_2": "💥 哪个故事情感冲击力最强？",
        "chat_suggest_poetry_1": "🎭 这部诗集的核心主题是什么？",
        "chat_suggest_poetry_2": "🖊 描述诗人的声音与意象。",
        "chat_suggest_academic_1": "📝 核心论点是什么？",
        "chat_suggest_academic_2": "🔑 关键概念有哪些？",
        "chat_suggest_essay_1": "✍️ 作者的核心主题？",
        "chat_suggest_essay_2": "💭 叙事视角分析？",
        "chat_suggest_technical_1": "⚙️ 这本书解决了什么技术问题？",
        "chat_suggest_technical_2": "🔑 书中介绍的核心概念和方法？",
        "chat_suggest_self_help_1": "💡 这本书教了什么框架或方法？",
        "chat_suggest_self_help_2": "✅ 最值得行动的洞见是什么？",
        # Library Tab
        "tab_library": "📚 书库",
        ...
        "verdict_label": "读者判断",
        "verdict_for_you": "✅ 适合",
        "verdict_not_for_you": "❌ 不适合",
        "verdict_low_confidence": "数据不足，仅供参考",
        # Fallback for character detection
    ...
    "ja": {
        ...
        "type_fiction": "小説",
        "type_biography": "伝記・回顧録",
        "type_short_stories": "短編小説",
        "type_poetry": "詩",
        ...
        # Chat suggested prompts
        "chat_suggest_fiction_1": "📖 各章で何が起きる？",
        "chat_suggest_fiction_2": "👥 主な登場人物は？",
        "chat_suggest_biography_1": "📷 この本が伝える人物の個性とは？",
        "chat_suggest_biography_2": "🌟 人物の人生における転換点は？",
        "chat_suggest_short_stories_1": "📖 各短編を要約して。",
        "chat_suggest_short_stories_2": "💥 最も印象的な短編はどれ？",
        "chat_suggest_poetry_1": "🎭 この詩集の中心テーマは？",
        "chat_suggest_poetry_2": "🖊 詩人の声と意象を描写して。",
        "chat_suggest_academic_1": "📝 核心的な論点は？",
        "chat_suggest_academic_2": "🔑 重要な概念は？",
        "chat_suggest_essay_1": "✍️ 著者の核心テーマは？",
        "chat_suggest_essay_2": "💭 語りの視点を分析して",
        "chat_suggest_technical_1": "⚙️ この本が扱う技術的問題は？",
        "chat_suggest_technical_2": "🔑 主要な概念・手法・フレームワークは？",
        "chat_suggest_self_help_1": "💡 この本が教えるフレームワークは？",
        "chat_suggest_self_help_2": "✅ 最も実践的なインサイトは？",
        # Library Tab
        "tab_library": "📚 ライブラリ",
        ...
        # Reader Verdict
        "verdict_label": "読者の判定",
        "verdict_for_you": "✅ おすすめ",
        "verdict_not_for_you": "❌ 向いてない",
        "verdict_low_confidence": "データ不足、参考程度に",
        # Fallback for character detection
