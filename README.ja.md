...
**多次元書籍テキスト分析・可視化プラットフォーム — 日本語・中文・English の3言語対応。**
...
- **ヒーローインサイトカード** — 主要感情・感情弧・語数を一目で確認
- **言語切り替え** — サイドバーで日本語 / English / 中文 を即時切り替え
- **わかりやすい解説** — すべてのグラフに平易な説明文つき（専門知識不要）
...
**UI全体**（ラベル・説明・感情弧パターン名・グラフタイトル）もサイドバーの言語トグルで日本語・English・中文に即時切り替えできます。
...
.streamlit/          Streamlit テーマ設定（ダークテーマ + パープルアクセント）
```
