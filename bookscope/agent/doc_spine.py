...
# 15 文种(《党政机关公文处理工作条例》法定文种)。文种识别只能落在这个封闭集里,
...
_HEAD_FIELDS: dict[str, str] = {
    "发文字号": "机关代字+年份+序号(如「X发〔2024〕5号」),文件唯一身份证;抽不到留空。",
    "文种": f"必须是这 15 文种之一{DOC_TYPES};判不准留空,绝不自造文种。",
    "发文机关": "谁发的(落款的机关全称或规范简称)。",
    "主送机关": "发给谁办理(主送对象)。",
    "抄送机关": "抄送给谁知会(没有就留空)。",
    "标题事由": "标题里「关于……」的事由部分。",
    "成文日期": "落款的成文日期(时效起算点),原样照抄如「2024年5月8日」。",
    "签发人": "签发人姓名(上行文才有,没有留空)。",
}
